            ...
            for iter in tqdm(range(n_iter)):
                ...
                if LOSS == 'MSE':
                    ...
                    if loss.item() < self.loss_mse_min:
                        ...
                        with open('data/least_MSE.pkl', 'wb') as outp:
                    ...
                    if loss.item() < self.loss_ll_penalized_min:
                        ...
                        with open('data/least_penalized_LL_diffusion.pkl', 'wb') as outp:
                            pickle.dump(self, outp, pickle.HIGHEST_PROTOCOL)
                            
                    if loss_ll.item() < self.loss_ll_min:
                        self.loss_ll_min = loss_ll.item()
                        with open('data/least_LL_diffusion.pkl', 'wb') as outp:
                            pickle.dump(self, outp, pickle.HIGHEST_PROTOCOL)
                    ...
                    if loss.item() < self.loss_ll_penalized_min:
                        self.loss_ll_penalized_min = loss.item()
                        with open('data/least_penalized_LL_combined.pkl', 'wb') as outp:
                            pickle.dump(self, outp, pickle.HIGHEST_PROTOCOL)
                            
                    if loss_ll.item() < self.loss_ll_min:
                        self.loss_ll_min = loss_ll.item()
                        with open('data/least_LL_combined.pkl' %self.ticker, 'wb') as outp:
                            pickle.dump(self, outp, pickle.HIGHEST_PROTOCOL)
